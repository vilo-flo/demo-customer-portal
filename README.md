...
Goal of the project is to demonstrate how the [Vilosia TDD Agent](https://www.tdd-agent.vilosia.com/) is being used to create Acceptance tests.
...
## Project Boards
https://github.com/users/vilo-flo/projects/1/views/1
